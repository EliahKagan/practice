...
// LeetCode #1579 scratchwork - Remove Max Number of Edges to Keep Graph Fully Traversable
...
new Solution().MaxNumEdgesToRemove(n, edges).Dump();
...
public class Solution {
                               ...
                               IEnumerable<(int, int)> edges)
    {
        ...
        foreach (var (u, v) in edges) {
            ...
            if (sets.Union(u, v).Dump($"({u}, {v})")) ++count;
        }
...
internal sealed class DisjointSets {
    ...
    private object ToDump() => new { _parents, _ranks };
