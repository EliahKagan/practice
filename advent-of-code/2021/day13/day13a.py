...
"""Advent of Code 2021, day 13, part A"""
...
def run() -> None:
    """
    Creates dots from stdin or a file and applies a single fold.

    In this version (A), input processing stops after the first fold.
    """
    dots = Dots()
    ...
    for line in map(str.strip, fileinput.input()):
        ...
        if fold_match is not None:
            ...
            break  # Because we are stopping after the first fold.
